...
enum opt_code
{
  ...
  OPT_mcmodel_ = 1277,                       /* -mcmodel= */
  OPT_mdiv = 1278,                           /* -mdiv */
  OPT_mexplicit_relocs = 1279,               /* -mexplicit-relocs */
  OPT_mfdiv = 1280,                          /* -mfdiv */
  OPT_mplt = 1281,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1282,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1283,                         /* -mrelax */
  OPT_mriscv_attribute = 1284,               /* -mriscv-attribute */
  OPT_msave_restore = 1285,                  /* -msave-restore */
  OPT_msmall_data_limit_ = 1286,             /* -msmall-data-limit= */
  OPT_mstrict_align = 1287,                  /* -mstrict-align */
  OPT_mtune_ = 1288,                         /* -mtune= */
  OPT_n = 1289,                              /* -n */
  OPT_no_canonical_prefixes = 1290,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1291,              /* -no-integrated-cpp */
  OPT_no_pie = 1292,                         /* -no-pie */
  OPT_nocpp = 1293,                          /* -nocpp */
  OPT_nodefaultlibs = 1294,                  /* -nodefaultlibs */
  OPT_nolibc = 1295,                         /* -nolibc */
  OPT_nophoboslib = 1296,                    /* -nophoboslib */
  OPT_nostartfiles = 1297,                   /* -nostartfiles */
  OPT_nostdinc = 1298,                       /* -nostdinc */
  OPT_nostdinc__ = 1299,                     /* -nostdinc++ */
  OPT_nostdlib = 1300,                       /* -nostdlib */
  OPT_o = 1301,                              /* -o */
  OPT_p = 1302,                              /* -p */
  OPT_pass_exit_codes = 1303,                /* -pass-exit-codes */
  /* OPT_pedantic = 1304, */                 /* -pedantic */
  OPT_pedantic_errors = 1305,                /* -pedantic-errors */
  OPT_pg = 1306,                             /* -pg */
  OPT_pie = 1307,                            /* -pie */
  OPT_pipe = 1308,                           /* -pipe */
  OPT_print_file_name_ = 1309,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1310,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1311,          /* -print-multi-directory */
  OPT_print_multi_lib = 1312,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1313,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1314,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1315,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1316,               /* -print-prog-name= */
  OPT_print_search_dirs = 1317,              /* -print-search-dirs */
  OPT_print_sysroot = 1318,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1319,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1320,                          /* -quiet */
  OPT_r = 1321,                              /* -r */
  OPT_remap = 1322,                          /* -remap */
  OPT_s = 1323,                              /* -s */
  OPT_save_temps = 1324,                     /* -save-temps */
  OPT_save_temps_ = 1325,                    /* -save-temps= */
  OPT_shared = 1326,                         /* -shared */
  OPT_shared_libgcc = 1327,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1328,               /* -shared-libphobos */
  /* OPT_specs = 1329, */                    /* -specs */
  OPT_specs_ = 1330,                         /* -specs= */
  OPT_static = 1331,                         /* -static */
  OPT_static_libasan = 1332,                 /* -static-libasan */
  OPT_static_libgcc = 1333,                  /* -static-libgcc */
  ...
  OPT_static_libphobos = 1339,               /* -static-libphobos */
  OPT_static_libstdc__ = 1340,               /* -static-libstdc++ */
  OPT_static_libtsan = 1341,                 /* -static-libtsan */
  OPT_static_libubsan = 1342,                /* -static-libubsan */
  OPT_static_pie = 1343,                     /* -static-pie */
  /* OPT_std_c__03 = 1344, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1345, */                /* -std=c++0x */
  OPT_std_c__11 = 1346,                      /* -std=c++11 */
  OPT_std_c__14 = 1347,                      /* -std=c++14 */
  OPT_std_c__17 = 1348,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1349, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1350, */                /* -std=c++1z */
  OPT_std_c__2a = 1351,                      /* -std=c++2a */
  OPT_std_c__98 = 1352,                      /* -std=c++98 */
  OPT_std_c11 = 1353,                        /* -std=c11 */
  OPT_std_c17 = 1354,                        /* -std=c17 */
  /* OPT_std_c18 = 1355, */                  /* -std=c18 */
  /* OPT_std_c1x = 1356, */                  /* -std=c1x */
  OPT_std_c2x = 1357,                        /* -std=c2x */
  /* OPT_std_c89 = 1358, */                  /* -std=c89 */
  OPT_std_c90 = 1359,                        /* -std=c90 */
  OPT_std_c99 = 1360,                        /* -std=c99 */
  /* OPT_std_c9x = 1361, */                  /* -std=c9x */
  OPT_std_f2003 = 1362,                      /* -std=f2003 */
  OPT_std_f2008 = 1363,                      /* -std=f2008 */
  OPT_std_f2008ts = 1364,                    /* -std=f2008ts */
  OPT_std_f2018 = 1365,                      /* -std=f2018 */
  OPT_std_f95 = 1366,                        /* -std=f95 */
  OPT_std_gnu = 1367,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1368, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1369, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1370,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1371,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1372,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1373, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1374, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1375,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1376,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1377,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1378,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1379, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1380, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1381,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1382, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1383,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1384,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1385, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1386, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1387,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1388, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1389, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1390, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1391, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1392, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1393,                     /* -std=legacy */
  OPT_symbolic = 1394,                       /* -symbolic */
  OPT_t = 1395,                              /* -t */
  OPT_time = 1396,                           /* -time */
  OPT_time_ = 1397,                          /* -time= */
  OPT_traditional = 1398,                    /* -traditional */
  OPT_traditional_cpp = 1399,                /* -traditional-cpp */
  OPT_trigraphs = 1400,                      /* -trigraphs */
  OPT_u = 1401,                              /* -u */
  OPT_undef = 1402,                          /* -undef */
  OPT_v = 1403,                              /* -v */
  OPT_version = 1404,                        /* -version */
  OPT_w = 1405,                              /* -w */
  OPT_wrapper = 1406,                        /* -wrapper */
  OPT_x = 1407,                              /* -x */
  OPT_z = 1408,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
